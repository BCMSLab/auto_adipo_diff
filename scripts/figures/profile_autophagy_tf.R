...
(profiles %>%
  ...
  ggsave(plot = .,
         filename = 'manuscript/figures/profile_autophagy_tf_a.png',
...
(df %>%
    ...
    theme(strip.background = element_blank(),
          ...
          panel.spacing = unit(0,"null"))) %>%
  ggsave(plot = .,
         filename = 'manuscript/figures/profile_autophagy_tf_b.png',
         width = 10, height = 6, units = 'cm')
...
# generate figures
## PPARG
png(filename = 'manuscript/figures/profile_autophagy_tf_c.png',
...
png(filename = 'manuscript/figures/profile_autophagy_tf_e.png',
...
png(filename = 'manuscript/figures/profile_autophagy_tf_d.png',
    width = 12, height = 6, units = 'cm', res = 300)
...
png(filename = 'manuscript/figures/profile_autophagy_tf_f.png',
